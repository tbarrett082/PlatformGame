(function (global, factory) {
  ...
  var GetLineToPoints = function GetLineToPoints(line, points, out) {
    ...
    */
    ...
    for (var i = 1; i < points.length; i++) {
      ...
      prev = current; // Ignore case: start point of line is at segment
  ...
  var GetLineToPolygon = function GetLineToPolygon(line, polygons, out) {
    ...
    */
    ...
    var closestIntersect = false;
    out.d = Infinity; //  Reset our vec4s

    for (var i = 0; i < polygons.length; i++) {
      var polygon = polygons[i]; // Run AABBTest when polygon is more than 8 edges
